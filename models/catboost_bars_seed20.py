"""Larger seed ensemble variant of the baseline CatBoost submission.

Uses the same feature set and CV-picked iteration count as seed5, but averages
20 independently-seeded models to reduce prediction variance further.
"""
...
sub_path = ROOT / "submissions" / "catboost_bars_seed20.csv"
